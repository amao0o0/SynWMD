...
class STSEval(object):
    def loadFile(self, fpath):
        ...
        for dataset in self.datasets:
            ...
            # modified 2/17
            self.samples_dataset[dataset] = sent1 + sent2
    ...
    def do_prepare(self, params, prepare):
        ...
        return prepare(params, self.samples, self.samples_dataset)
        ...
        for dataset in self.datasets:
            ...
            for ii in range(0, len(gs_scores), params.batch_size):
                ...
                if len(batch1) == len(batch2) and len(batch1) > 0:
                    enc1 = batcher(params, batch1, dataset)
                    enc2 = batcher(params, batch2, dataset)
...
#%% Modified 02/14/2021 add unsupervised for STSB
class STSBun(object):
    def loadFile(self, fpath):
        self.data = {}
        self.samples = []
        ...
        for dataset in self.datasets:
            ...
            with io.open(fpath + '/%s.csv' % dataset, 'r', encoding='utf-8') as f:
...
class STSBun_Eval(STSBun):
    def __init__(self, taskpath, seed=1111):
        logging.debug('***** Transfer task : STSB unsupervised *****\n\n')
        self.seed = seed
        self.datasets = ['sts-train', 'sts-dev', 'sts-test']
        self.loadFile(taskpath)